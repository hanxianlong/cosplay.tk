            ...
            <table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="683" height="350" align="center" valign="top"><table width="679" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="147"><img src="<?php echo the_post_thumbnail_url('48'); ?>" width="679" height="133" /></td>
                  </tr>
                </table>
...
if (have_posts()) :
    ...
    if ($i%3==0) echo '<tr>';
            $i = $i+1;
 ?>
<td width="227" height="135" align="left" valign="middle">
    <table width="209" border="0" cellpadding="0" cellspacing="0">
                        <tbody><tr>
                          <td height="130" background="<?php echo get_template_directory_uri() ?>/images/029.gif">
                              <table width="190" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><a href="/?p=<?php the_ID() ?>" title="<?php the_title_attribute(); ?>" class="wenzi"><img src="<?php echo the_post_thumbnail_url(get_the_ID()); ?>" width="197" height="112" border="0"></a></td>
                                </tr>
                         ...
                         <tr>
                             <td height="26" align="center"><a href="/?p=<?php the_ID() ?>" title="<?php the_title_attribute(); ?>" class="wenzi"><?php echo mb_strimwidth(get_the_title(), 0,20); ?></a></td>
                                </tr>
                      </tbody>
    </table>
</td>
                          <?php if ($i%3==0) echo '</tr><tr><td colspan="3" height="31px"><img src="' . get_template_directory_uri() . '/images/033.gif" width="679" height="3" /></td></tr>' ?>
                    <?php
                    endwhile;
      endif ?>
                  </table>
